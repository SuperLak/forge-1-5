...
import net.kal.tutorialmod.world.dimension.KJTeleporter;
import net.kal.tutorialmod.world.dimension.ModDimensions;
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos,
        ...
        if (!worldIn.isRemote()) {
            if (!player.isCrouching()) {
                ...
                if (server != null) {
                    if (worldIn.getDimensionKey() == ModDimensions.KalDim) {
                        ServerWorld overWorld = server.getWorld(World.OVERWORLD);
                        if (overWorld != null) {
                            player.changeDimension(overWorld, new KJTeleporter(pos, false));
                        }
                    } else {
                        ServerWorld kalDim = server.getWorld(ModDimensions.KalDim);
                        if (kalDim != null) {
                            player.changeDimension(kalDim, new KJTeleporter(pos, true));
                        }
                    }
