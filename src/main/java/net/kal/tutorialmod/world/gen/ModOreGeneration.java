...
public class ModOreGeneration {
    public static void generateOres(final BiomeLoadingEvent event) {
        spawnOreInSpecificModBiome(ModBiomes.RIFT_BIOME.get(), OreType.MADRA, event, Dimension.OVERWORLD.toString());
        spawnOreInSpecificBiome(Biomes.DARK_FOREST, OreType.MADRA, event, Dimension.OVERWORLD.toString());
        spawnOreInAllBiomes(OreType.RUBY, event, Dimension.OVERWORLD.toString());
        spawnOreInAllBiomes(OreType.RUBY, event, Dimension.THE_NETHER.toString());
    }
