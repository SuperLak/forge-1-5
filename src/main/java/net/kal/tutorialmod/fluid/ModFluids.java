package net.kal.tutorialmod.fluid;
...
public class ModFluids {
    ...
    public static final ForgeFlowingFluid.Properties OIL_PROPERTIES = new ForgeFlowingFluid.Properties(
            ...
            .color(0xbffed0d0)).slopeFindDistance(8).levelDecreasePerBlock(1)
            .block(() -> ModFluids.OIL_BLOCK.get()).bucket(() -> ModItems.OIL_BUCKET.get());

    public static final RegistryObject<FlowingFluidBlock> OIL_BLOCK = ModBlocks.registerRubyBlock("oil",
